...
<div>
    <div class="goback">
     <el-link :underline="false" type="primary" @click="goback">未分流</el-link>  <i class="el-icon-arrow-right"></i> <el-link :underline="false" type="primary" >详情</el-link>
    </div>
    <div class="detailbox">
       <div class="top">
...
<script>
import {JQcj, JQfk,JQjj} from '@/api/table'
export default {
    data(){
        return{
